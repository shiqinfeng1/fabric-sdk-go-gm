...
```bash
go get -u github.com/shiqinfeng1/fabric-sdk-go-gm/tjfoc/gmsm
```
...
导入包
```Go
import github.com/shiqinfeng1/fabric-sdk-go-gm/tjfoc/gmsm/sm3
```
...
导入包
```Go
import github.com/shiqinfeng1/fabric-sdk-go-gm/tjfoc/gmsm/sm4
```
...
导入包
```Go
import github.com/shiqinfeng1/fabric-sdk-go-gm/tjfoc/gmsm/sm2
```
